...
# Set up paths
json_path = r"C:\Users\natda\Downloads\stop.json"
output_gdb = r"C:\Users\natda\Downloads\osm_stops.gdb"
output_fc = "osm_stop_signs"
...
# Extract node data and filter for stop signs (highway=stop)
nodes = [node for node in json_data.get('elements', []) if node.get('tags', {}).get('highway') == 'stop']
...
print(f"Stop sign data successfully converted to GDB at: {output_gdb}")
